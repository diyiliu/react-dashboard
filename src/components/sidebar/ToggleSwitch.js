...
const ToggleSwitch = () => {
    ...
    return (
        <Switch>
            <input type="checkbox" className="switch-input" id="switchCheckbox1" onClick={toggleTheme}/>
            <label aria-hidden="true" className="switch-label" htmlFor="switchCheckbox1">On</label>
            <div aria-hidden="true" className="switch-marker"></div>
        </Switch>
    );
};
